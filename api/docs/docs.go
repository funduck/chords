...
const docTemplate = `{
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/chords_com_api_internal_entity.Auth"
                            }
                        }
                    }
                }
    ...
    "definitions": {
        ...
        "chords_com_api_internal_entity.Auth": {
            "type": "object",
            "required": [
                "created_at",
                "id",
            ...
            "properties": {
                "action_code": {
                    "description": "Action code for email confirmation or other actions",
                    "type": "string"
                },
                "created_at": {
                    "type": "string"
                ...
                "identity": {
                    "description": "Unique identity for the auth method (e.g., email)",
                    "type": "string"
                },
                "status": {
                    "$ref": "#/definitions/chords_com_api_internal_entity.AuthStatus"
                },
                "type": {
                    "$ref": "#/definitions/chords_com_api_internal_entity.AuthType"
                },
                "updated_at": {
                    "type": "string"
                },
        ...
        "chords_com_api_internal_entity.AuthStatus": {
            "type": "string",
            "enum": [
            ...
            "x-enum-varnames": [
                "AuthStatus_WaitingForConfirmation",
                "AuthStatus_Active"
            ]
        },
        "chords_com_api_internal_entity.AuthType": {
            "type": "string",
            "enum": [
                "email"
            ],
