...
These directives change the font, size and colour of the [grids](./directives-env_grid.md).  
Note that these are **not** the chord diagrams typically printed at the end of the song.
