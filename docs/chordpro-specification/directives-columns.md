...
This directives specifies that the song must be printed in *ncol*
columns.
...
See also:
[settings.columns](https://www.chordpro.org/chordpro/chordpro-configuration-generic/#columns).
